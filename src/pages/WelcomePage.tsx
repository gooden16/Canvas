      ...
      <div className="canvas-container py-12 md:py-24">
        <div className="text-center mb-12 md:mb-16">
          <h1 className="mb-6 animate-fade-in">
            <span className="font-raleway text-4xl md:text-5xl lg:text-6xl font-semibold text-canvas-cream">
              Brilliant<span className="text-canvas-pink-dusty">*</span>
            </span>
            <span className="font-playfair text-4xl md:text-5xl lg:text-6xl font-bold text-canvas-cream"> Financial </span>
            <span className="font-playfair text-4xl md:text-5xl lg:text-6xl font-bold text-canvas-gold">Canvas</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16 animate-fade-in">
          <div className="bg-canvas-navy bg-opacity-50 border border-canvas-mediumgray rounded-lg p-6 hover:border-canvas-gold transition-all duration-300">
          ...
          <div className="bg-canvas-navy bg-opacity-50 border border-canvas-mediumgray rounded-lg p-6 hover:border-canvas-gold transition-all duration-300">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-playfair ml-3">Metrics That Actually Matter</h3>
            </div>
            <p className="text-canvas-cream opacity-80">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8 md:space-y-0 md:grid md:grid-cols-3 md:gap-8">
              <div className="text-center group">
                <div className="bg-canvas-gold text-canvas-navy rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 transform transition-transform group-hover:scale-110 duration-300">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div className="md:w-1/2 bg-canvas-navy bg-opacity-50 border border-canvas-mediumgray rounded-lg p-6 hover:border-canvas-gold transition-all duration-300">
      ...
      <footer className="bg-canvas-navy border-t border-canvas-mediumgray py-8">
        <div className="canvas-container text-center">
          <p className="text-canvas-cream opacity-60 text-sm">
            &copy; 2025 <span className="font-raleway">Brilliant<span className="text-canvas-pink-dusty">*</span></span> Financial. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
